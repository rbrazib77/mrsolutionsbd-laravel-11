...
@section('title', 'Why Choose Us List')
@section('admin')
    <div class="content">
        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Why Choose Us List</h4>
                </div>

                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.why-choose-us.create') }}" class="btn btn-success">New Why Choose Us
                            Create</a>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="responsive-datatable"
                                ...
                                <tbody>
                                    @foreach ($whyFeature as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $item->title }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-url="{{ route('admin.why-choose-us.active.deactive', $item->id) }}"
                                            ...
                                            <td>
                                                <a href="{{ route('admin.why-choose-us.details', $item->id) }}"
                                                    class="btn btn-primary">View</a>
                                                <a href="javascript:void(0);" class="btn btn-danger delete-btn"
                                                    data-url="{{ route('admin.why-choose-us.destroy', $item->id) }}">Delete</a>
                                        ...
                                        <div class="modal fade" id="editBannerModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <form action="{{ route('admin.why-choose-us.update', $item->id) }}"
                                                        method="POST">
                                                        @csrf
