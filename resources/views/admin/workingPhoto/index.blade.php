...
@section('title', 'Working Photo List')
@section('admin')
    <div class="content">
        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Working Photo List</h4>
                </div>
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.working-photo.create') }}" class="btn btn-success">New Working Photo Add</a>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="responsive-datatable"
                                ...
                                <tbody>
                                    @foreach ($workingPhotos as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <img src="{{ !empty($item->image) ? url('upload/workingPhotos/' . $item->image) : url('upload/no_image.jpg') }}"
                                                    alt="image profile"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-url="{{ route('admin.working-photo.active.deactive', $item->id) }}"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="btn btn-danger delete-btn"
                                                    data-url="{{ route('admin.working-photo.destroy', $item->id) }}">Delete</a>
                                        ...
                                        <div class="modal fade" id="editBannerModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <form action="{{ route('admin.working-photo.update', $item->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                @if ($item->image)
                                                                    <img src="{{ asset('upload/workingPhotos/' . $item->image) }}"
                                                                        alt="banner image"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="example-select" class="form-label">Category
                                                                    Button</label>
