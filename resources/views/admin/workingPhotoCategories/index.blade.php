...
@section('title', 'Working Photo Category List')
@section('admin')
    <div class="content">
        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">New Category Button Create</h4>
                </div>
            </div>
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Working Photo Category Button List</h4>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-url="{{ route('admin.category.active.deactive', $item->id) }}"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="btn btn-danger delete-btn"
                                                    data-url="{{ route('admin.category.destroy', $item->id) }}">Delete</a>
