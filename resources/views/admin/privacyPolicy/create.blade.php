...
@section('title', 'New Privacy Policy Create')
@section('admin')
        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">New Privacy Policy Create</h4>
                </div>

                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.privacy-policy.index') }}" class="btn btn-success">Privacy Policy List</a>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="col-lg-8">
                                    <form action="{{ route('admin.privacy-policy.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="example-textarea"
                                                rows="20" spellcheck="false" placeholder="Content">{{ old('content') }}</textarea>
                                            @error('content')
                                                <span class="text-danger" style="font-size: 14px;">{{ $message }}</span>
                                            @enderror
                                        </div>
