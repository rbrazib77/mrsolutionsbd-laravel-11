        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Activities List</h4>
                </div>

                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.activity.create') }}" class="btn btn-success">New Activities
                            Create</a>
                    </ol>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-url="{{ route('admin.activity.active.deactive', $item->id) }}"
                                            ...
                                            <td>
                                                <a href="{{ route('admin.activity.details', $item->id) }}"
                                                    class="btn btn-primary">View</a>
                                                <a href="javascript:void(0);" class="btn btn-danger delete-btn"
                                                    data-url="{{ route('admin.activity.destroy', $item->id) }}">Delete</a>
                                        ...
                                        <div class="modal fade" id="editBannerModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <form action="{{ route('admin.activity.update', $item->id) }}"
                                                        method="POST">
                                                        @csrf
