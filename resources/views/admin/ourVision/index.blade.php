        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Our Vision Section Update</h4>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.our-vision.update', $vision->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form action="{{ route('admin.working-video.store') }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                <img id="preview_top"
                                                    src="{{ !empty($vision->top_image) ? url('upload/visions/' . $vision->top_image) : url('upload/no_image.jpg') }}"
                                            ...
                                            <div class="mb-3">
                                                <img id="preview_bottom_right"
                                                    src="{{ !empty($vision->bottom_right_image) ? url('upload/visions/' . $vision->bottom_right_image) : url('upload/no_image.jpg') }}"
                                                    class="avatar-xxl img-thumbnail" alt="image profile"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            <img id="preview_bottom_left"
                                                src="{{ !empty($vision->bottom_left_image) ? url('upload/visions/' . $vision->bottom_left_image) : url('upload/no_image.jpg') }}"
                                                class="avatar-xxl img-thumbnail" alt="image profile"
                                                style="width: 250px; height: 180px;">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="small_title" id="example-email"
                                                ...
                                                value="{{ old('small_title', $vision->small_title) }}">
                                            @error('small_title')
                                                <span class="text-danger" style="font-size: 14px;">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="example-email"
                                                ...
                                                placeholder="Title" value="{{ old('title', $vision->title) }}">
                                            @error('title')
                                                <span class="text-danger" style="font-size: 14px;">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="example-textarea"
                                                rows="5" spellcheck="false" placeholder="Description">{{ old('description', $vision->description) }}</textarea>
                                            @error('description')
                                                <span class="text-danger" style="font-size: 14px;">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <label for="editStatus{{ $vision->id }}" class="form-label">Status</label>
                                            <select name="status" class="form-select"
                                                id="editStatus{{ $vision->id }}">
                                                <option value="1"
                                                    {{ old('status', $vision->status) == 1 ? 'selected' : '' }}>
                                                    Active</option>
                                                <option value="0"
                                                    {{ old('status', $vision->status) == 0 ? 'selected' : '' }}>
                                                    Deactive</option>
                                            </select>
                                        </div>
                                    </div>
