        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">New Working Video Add</h4>
                </div>

                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.working-video.index') }}" class="btn btn-success">Working Videos List</a>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="{{ route('admin.working-video.store') }}" method="POST"
                                        ...
                                        @csrf
                                        <div class="mb-3">
                                            <label for="image" class="form-label">Working Video Thumbnail<small
                                                    class="text-danger">
                                        ...
                                        <div class="mb-3">
                                            <img id="showImage"
                                                src="{{ !empty($profileData->thumbnail) ? url('upload/user_images/' . $profileData->photo) : url('upload/no_image.jpg') }}"
                                        ...
                                        <div class="mb-3">
                                            <label for="example-email" class="form-label">Youtube URL</label>
                                            <input type="text" name="youtube_url" id="example-email"
