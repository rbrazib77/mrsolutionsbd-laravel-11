...
@section('title', 'Working Video List')
@section('admin')
    <div class="content">
        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Working Video List</h4>
                </div>
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.working-video.create') }}" class="btn btn-success">New Working Video Add</a>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="responsive-datatable"
                                ...
                                <tbody>
                                    @foreach ($workingVideos as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <img src="{{ !empty($item->thumbnail) ? url('upload/video_thumbnails/' . $item->thumbnail) : url('upload/no_image.jpg') }}"
                                                    alt="image profile"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-url="{{ route('admin.working-video.active.deactive', $item->id) }}"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="btn btn-danger delete-btn"
                                                    data-url="{{ route('admin.working-video.destroy', $item->id) }}">Delete</a>
                                                ...
                                                <div class="modal fade" id="editBannerModal{{ $item->id }}"
                                                    ...
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            <form
                                                                action="{{ route('admin.working-video.update', $item->id) }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Video Thumbnail<small
                                                                                class="text-danger">
                                                                                (jpeg, png, jpg, gif, webp, Recommended
                                                                                Size: 380x225px)
                                                                            </small></label>
                                                                        <input name="thumbnail"
                                                                            class="form-control editImage" type="file">

                                                                        @if ($item->thumbnail)
                                                                            <img src="{{ asset('upload/video_thumbnails/' . $item->thumbnail) }}"
                                                                                alt="banner image"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="example-email"
                                                                            class="form-label">Youtube URL</label>
