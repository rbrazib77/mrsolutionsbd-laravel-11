        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Social Media List</h4>
                </div>

                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.social.media.create') }}" class="btn btn-success">New Social Media
                            Create</a>
                    </ol>
                </div>
            </div>
                            ...
                            <table id="responsive-datatable"
                                ...
                                <tbody>
                                    @foreach ($socialMedia as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-url="{{ route('admin.social.media.active.deactive', $item->id) }}"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="btn btn-danger delete-btn"
                                                    data-url="{{ route('admin.social.media.destroy', $item->id) }}">Delete</a>
                                        ...
                                        <div class="modal fade" id="editSocialModal{{ $item->id }}" tabindex="-1"
                                            aria-labelledby="editSocialModalLabel{{ $item->id }}" aria-hidden="true">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-4 mt-3">
                                                                ...
                                                                <input type="text" name="url"
                                                                    ...
                                                                    value="{{ old('url', $item->url) }}" placeholder="Url">
                                                                @error('url')
                                                                    <span class="text-danger"
                                                                        style="font-size: 14px;">{{ $message }}</span>
                                                                @enderror
