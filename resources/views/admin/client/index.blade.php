        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Clients List</h4>
                </div>
                <div class="text-end">
                    <ol class="breadcrumb m-0 py-0">
                        <a href="{{ route('admin.client.create') }}" class="btn btn-success">New Client Add</a>
                    </ol>
                </div>
            </div>
                                ...
                                <tbody>
                                    @foreach ($clients as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <img src="{{ !empty($item->logo) ? url('upload/clients/' . $item->logo) : url('upload/no_image.jpg') }}"
                                                    alt="image profile"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-url="{{ route('admin.client.active.deactive', $item->id) }}"
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="btn btn-danger delete-btn"
                                                    data-url="{{ route('admin.client.destroy', $item->id) }}">Delete</a>
                                        ...
                                        <div class="modal fade" id="editBannerModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <form action="{{ route('admin.client.update', $item->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label class="form-label">Client Logo<small
                                                                        class="text-danger">
                                                                        (jpeg, png, jpg, gif, webp, Recommended
                                                                        Size: 380x225px)
                                                                    </small></label>
                                                                <input name="logo" class="form-control editImage"
                                                                    type="file">

                                                                @if ($item->logo)
                                                                    <img src="{{ asset('upload/clients/' . $item->logo) }}"
                                                                        alt="banner image"
